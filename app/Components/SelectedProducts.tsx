...
//     <div className="">
//       <div
//         className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-hidden"
...
//                p-4 sm:p-6 relative animate-fadeIn"
  ...
  return (
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-x-hidden">
      ...
      >
        ...
        <button
          onClick={() => setSelectedProduct(null)}
          className="absolute top-3 right-3 bg-black text-white w-7 h-7 rounded-full flex items-center justify-center z-30 cursor-pointer"
        >
          ✕
        </button>
        ...
        <div className="flex flex-col gap-5">
          ...
          >
            <img
              src={`https://localhost:7142${images[currentIndex]}`}
              alt={selectedProduct.name}
            ...
            <button
              ...
              bg-white/70 hover:bg-white w-8 h-8 rounded-full
            ...
            {images.map((_, index) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full ${
                  index === currentIndex ? "bg-[#2c2320]" : "bg-gray-300"
                }`}
              />
            ))}
          </div>
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="w-full bg-[#2c2320] text-white py-2.5 rounded-xl
              hover:bg-black transition text-sm sm:text-base font-semibold cursor-pointer"
            >
              أضف للسلة
            </button>
          </div>
